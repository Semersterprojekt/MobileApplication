...
app.controller('CameraCtrl', function ($scope, $cordovaToast, $cordovaCamera, $http, $ionicPopup, $cordovaGeolocation, $state) {
  ...
  var intervalID =  setInterval(getCoordiantes, 3000);
